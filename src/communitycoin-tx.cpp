...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Communitycoin Core communitycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  communitycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded communitycoin transaction") + "\n" +
              "  communitycoin-tx [options] -create [commands]   " + _("Create hex-encoded communitycoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded communitycoin transaction
