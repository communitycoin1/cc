    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Communitycoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and communitycoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Communitycoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Communitycoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Communitycoin Core"));
    ...
    openAction->setStatusTip(tr("Open a communitycoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Communitycoin Core help message to get a list with possible Communitycoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Communitycoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Communitycoin Core"); // default title
    ...
    // Append title to "Communitycoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
