    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("COMMUNITYCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("COMMUNITYCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("COMMUNITYCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("COMMUNITYCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("COMMUNITYCOIN-traditional"), QVariant("trad"));
