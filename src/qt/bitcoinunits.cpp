...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case COMMUNITYCOIN: return QString("COMMUNITYCOIN");
    ...
    else
    {
        switch(unit)
        {
            case COMMUNITYCOIN: return QString("tDASH");
...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        ...
        {
            case COMMUNITYCOIN: return QString("Communitycoin");
            case mDASH: return QString("Milli-Communitycoin (1 / 1" THIN_SP_UTF8 "000)");
            case uDASH: return QString("Micro-Communitycoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-Communitycoin (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case COMMUNITYCOIN: return QString("TestDashs");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case COMMUNITYCOIN:  return 100000000;
