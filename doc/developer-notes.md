...
Communitycoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 22306.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 8283 for connections and services them.
...
However, in open source software such as Communitycoin Core, where everyone uses
...
pay attention to for reviewers of Communitycoin Core code.

General Communitycoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Communitycoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
