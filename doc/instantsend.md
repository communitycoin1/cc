...
This mechanism has been integrated into Bitcore-Node-Communitycoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashpay/insight-api-communitycoin#web-socket-api](https://github.com/dashpay/insight-api-communitycoin#web-socket-api)
* API: [https://github.com/dashpay/insight-api-communitycoin#instantsend-transactions](https://github.com/dashpay/insight-api-communitycoin#instantsend-transactions)
...
By default, the Communitycoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Communitycoin Core daemon:
