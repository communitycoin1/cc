TOR SUPPORT IN COMMUNITYCOIN CORE
=======================

It is possible to run Communitycoin Core as a Tor hidden service, and connect to such services.
...
1. Run Communitycoin Core behind a Tor proxy
----------------------------------

The first step is running Communitycoin Core behind a Tor proxy. This will already make all
...
2. Run a Communitycoin Core hidden server
-------------------------------
...
config file):
	...
	HiddenServicePort 22306 127.0.0.1:22306
	HiddenServicePort 22316 127.0.0.1:22316

The directory can be different of course, but (both) port numbers should be equal to
your dashd's P2P listen port (22306 by default).

	-externalip=X   You can tell Communitycoin Core about its publicly reachable address using
...
and open port 22306 on your firewall (or use -upnp).
...
3. List of known Communitycoin Core Tor relays
------------------------------------
...
Communitycoin Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Communitycoin Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Communitycoin Core is listening, and
