...
Only requiring some minor changes is communitycoin.cpp.
...
Changes to communitycoin.cpp
----------------------
communitycoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
